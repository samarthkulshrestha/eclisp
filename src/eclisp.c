...
lval* builtin_head(lval* a) {
    LASSERT(a, a->count == 1,
            "func 'head' -> too many args.");
    LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
            "func 'head' -> incorrect type.");
    LASSERT(a, a->cell[0]->count != 0,
            "func 'head' -> empty qexpr '{}'");
...
lval* builtin_tail(lval* a) {
    LASSERT(a, a->count == 1,
            "func 'tail' -> too many args.");
    LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
            "func 'tail' -> incorrect type.");
    LASSERT(a, a->cell[0]->count != 0,
            "func 'tail' -> empty qexpr '{}'");
...
lval* builtin_eval(lval* a) {
    LASSERT(a, a->count == 1,
            "func 'eval' -> too many args.");
    LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
            "func 'eval' -> incorrect type.");
